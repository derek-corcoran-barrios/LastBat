...
`psi(I(Burn.intensity.Canopy^2))` && `psi(I(Burn.intensity.basal^2))`)& `p(Meantemp)`& `p(Meanhum)`& `p(Meanhum)`)
...
plot(Occu1.layer.MyCi$Predicted*PNF, colNA="black", main="Occupancy estimation for Western Small Footed Myotis",breaks=brks, col=cols, lab.breaks=brks, zlim=c(0,1))
...
plot(Occu1.layer.LaBl2$Predicted*PNF, colNA="black", main="Occupancy estimation for Western Red Bat",breaks=brks, col=cols, lab.breaks=brks, zlim=c(0,1))
...
plot(Occu1.layer.MyEv2$Predicted, colNA="black", main="Occupancy estimation for Long Eared Bat",breaks=brks, col=cols, lab.breaks=brks, zlim=c(0,1))
...
plot(Occu1.layer.AnPa2$Predicted*PNF, colNA="black", main="Occupancy estimation for Pallid Bat",breaks=brks, col=cols, lab.breaks=brks, zlim=c(0,1))
...
plot(Occu1.layer.MyTh2$Predicted*PNF, colNA="black", main="Occupancy estimation for Fringed Bat",breaks=brks, col=cols, lab.breaks=brks, zlim=c(0,1))
...
plot(Occu1.layer.CoTo2$Predicted*PNF, colNA="black", main="Occupancy estimation for Townsend big eared bat",breaks=brks, col=cols, lab.breaks=brks, zlim=c(0,1))
...
plot(Occu1.layer.PaHe2$Predicted, colNA="black", main="Occupancy estimation for Pipistrel",breaks=brks, col=cols, lab.breaks=brks, zlim=c(0,1))
...
plot(Occu1.layer.EpFu2$Predicted, colNA="black", main="Occupancy estimation for Big Brown Bat",breaks=brks, col=cols, lab.breaks=brks, zlim=c(0,1))
library(texreg)
htmlreg(extract(subset(select.Ep.Fu2, delta <= 2, recalc.weights = TRUE)))
```
...
plot(Occu1.layer.LaNo2$Predicted, colNA="black", main="Occupancy estimation for Silver Haired Bat",breaks=brks, col=cols, lab.breaks=brks, zlim=c(0,1))
...
plot(Occu1.layer.TaBr2$Predicted, colNA="black", main="Occupancy estimation for Brazilian free-tailed bat",breaks=brks, col=cols, lab.breaks=brks, zlim=c(0,1))
...
plot(Occu1.layer.LaCi2$Predicted, colNA="black", main="Occupancy estimation for Hoary Bat",breaks=brks, col=cols, lab.breaks=brks, zlim=c(0,1))
...
plot(Occu1.layer.EuMa2$Predicted, colNA="black", main="Occupancy estimation for Spotted Bat",breaks=brks, col=cols, lab.breaks=brks, zlim=c(0,1))
...
plot(Occu1.layer.EuPe2$Predicted*PNF, colNA="black", main="Occupancy estimation for western mastiff bat",breaks=brks, col=cols, lab.breaks=brks, zlim=c(0,1))
