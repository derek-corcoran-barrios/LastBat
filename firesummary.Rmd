...
model.Occu1.La.Bl2 <- occu(~ sdhum ~  Burn.intensity.Canopy + I(Burn.intensity.Canopy^2) + Burn.intensity.basal + I(Burn.intensity.basal^2) + fire_dist + forest_dist, SimOccuLaBl2)
...
model.Occu1.My.Ev2 <- occu(~ Maxhum + Maxtemp ~ Burn.intensity.soil + I(Burn.intensity.soil^2) + Burn.intensity.Canopy + I(Burn.intensity.Canopy^2) + Burn.intensity.basal + I(Burn.intensity.basal^2) + fire_dist + forest_dist, SimOccuMyEv2)

select.My.Ev2 <- dredge(model.Occu1.My.Ev2, rank = "AICc", subset= !(  
`psi(Burn.intensity.Canopy)` && `psi(Burn.intensity.basal)` ||
`psi(Burn.intensity.Canopy)` && `psi(I(Burn.intensity.basal^2))` ||
`psi(I(Burn.intensity.Canopy^2))` && `psi(Burn.intensity.basal)` ||
`psi(I(Burn.intensity.Canopy^2))` && `psi(I(Burn.intensity.basal^2))`)  & `p(Maxtemp)`&`p(Maxhum)`)
...
model.Occu1.An.Pa2 <- occu(~ Maxhum + Meanhum + Mintemp ~Burn.intensity.Canopy + I(Burn.intensity.Canopy^2) + Burn.intensity.basal + I(Burn.intensity.basal^2) + fire_dist + forest_dist, SimOccuAnPa2)

select.An.Pa2 <- dredge(model.Occu1.An.Pa2, rank = "AICc", subset= !( 
`psi(Burn.intensity.Canopy)` && `psi(Burn.intensity.basal)` ||
`psi(Burn.intensity.Canopy)` && `psi(I(Burn.intensity.basal^2))` ||
`psi(I(Burn.intensity.Canopy^2))` && `psi(Burn.intensity.basal)` ||
`psi(I(Burn.intensity.Canopy^2))` && `psi(I(Burn.intensity.basal^2))`) & `p(Maxhum)`&`p(Meanhum)` &`p(Mintemp)`)
...
model.Occu1.My.Th2 <- occu(~ sdhum + sdtemp ~ Burn.intensity.Canopy + I(Burn.intensity.Canopy^2) + Burn.intensity.basal + I(Burn.intensity.basal^2) + fire_dist + forest_dist, SimOccuMyTh2)
...
`psi(Burn.intensity.Canopy)` && `psi(I(Burn.intensity.basal^2))` ||
`psi(I(Burn.intensity.Canopy^2))` && `psi(Burn.intensity.basal)` ||
`psi(I(Burn.intensity.Canopy^2))` && `psi(I(Burn.intensity.basal^2))`) & `p(sdtemp)`&`p(sdhum)`)
...
model.Occu1.Co.To2 <- occu(~ Julian + Maxhum ~ Burn.intensity.Canopy + I(Burn.intensity.Canopy^2) + Burn.intensity.basal + I(Burn.intensity.basal^2) + fire_dist + forest_dist, SimOccuCoTo2)
...
`psi(Burn.intensity.Canopy)` && `psi(I(Burn.intensity.basal^2))` ||
`psi(I(Burn.intensity.Canopy^2))` && `psi(Burn.intensity.basal)` ||
`psi(I(Burn.intensity.Canopy^2))` && `psi(I(Burn.intensity.basal^2))`)& `p(Julian)`&`p(Maxhum)`)
