...
g<-ggplot(summarised_df1,aes(y = mean, x = variable, fill = FIRE))
...
Occupancy.table <- rbind(Occupancy.table,Total.occupancy)

Total
length(Total)
kable(cbind(Occupancy.table, Total))
Occupancy.table <- cbind(Occupancy.table, Total)
write.csv(Occupancy.table, "occupancytable.csv")
...
Detection.table <- rbind(Detection.table,Total.detection)

Total
length(Total)
kable(cbind(Detection.table, Total))
Detection.table <- cbind(Detection.table, Total)
write.csv(Detection.table, "Detectiontable.csv")
