...
saveRDS(Occu1.layer.MyYu2$Predicted, "Myyu_Firelayer.rds")
...
library(texreg)
htmlreg(extract(subset(select.My.Ca2, delta <= 2, recalc.weights = TRUE)))
saveRDS(Occu1.layer.MyCa2$Predicted, "Myca_FireLayer.rds")
...
saveRDS(Occu1.layer.MyCi, "Myci_FireLayer.rds")
...
saveRDS(Occu1.layer.MyVo, "MyVo_FireLayer.rds")
...
saveRDS(Occu1.layer.MyLu2, "MyLu_FireLayer.rds")
...
saveRDS(Occu1.layer.LaBl2, "Labl_FireLayer.rds")
...
saveRDS(Occu1.layer.MyEv2, "Myev_FireLayer.rds")
...
saveRDS(Occu1.layer.AnPa2, "Anpa_FireLayer.rds")
...
saveRDS(Occu1.layer.MyTh2, "Myth2_FireLayer.rds")
...
saveRDS(Occu1.layer.CoTo2, "Coto_FireLayer.rds")
...
saveRDS(Occu1.layer.PaHe2, "Pahe_FireLayer.rds")
...
# 
# 
select.Ep.Fu2 <- dredge(model.Occu1.Ep.Fu2, rank = "AICc", subset= !( `psi(Burn.intensity.Canopy)` && `psi(Burn.intensity.basal)` ||
`psi(Burn.intensity.Canopy)` && `psi(I(Burn.intensity.basal^2))` ||
`psi(I(Burn.intensity.Canopy^2))` && `psi(Burn.intensity.basal)` ||
...
saveRDS(Occu1.layer.EpFu2, "Epfu_FireLayer.rds")
library(texreg)
htmlreg(extract(subset(select.Ep.Fu2, delta <= 2, recalc.weights = TRUE)))
```
...
saveRDS(Occu1.layer.LaNo2, "Lano_FireLayer.rds")
# 
library(texreg)
htmlreg(extract(subset(select.La.No2, delta <= 2, recalc.weights = TRUE)))
```
...
saveRDS(Occu1.layer.TaBr2, "Tabr_FireLayer.rds")
# 
library(texreg)
htmlreg(extract(subset(select.Ta.Br2, delta <= 2, recalc.weights = TRUE)))
```
...
saveRDS(Occu1.layer.LaCi2, "Laci_FireLayer.rds")
# 
library(texreg)
htmlreg(extract(subset(select.La.Ci2, delta <= 2, recalc.weights = TRUE)))
```
...
saveRDS(Occu1.layer.EuMa2, "Euma_FireLayer.rds")
...
# 
# 
select.Eu.Pe2 <- dredge(model.Occu1.Eu.Pe2, rank = "AICc", subset= !( `psi(Burn.intensity.Canopy)` && `psi(Burn.intensity.basal)` ||
`psi(Burn.intensity.Canopy)` && `psi(I(Burn.intensity.basal^2))` ||
`psi(I(Burn.intensity.Canopy^2))` && `psi(Burn.intensity.basal)` ||
...
saveRDS(Occu1.layer.EuPe2, "Eupe_Fire.rds")
```
...
saveRDS(Occu1.layer.EuPe2, "Eupe_FireLayer.rds")
# 
library(texreg)
htmlreg(extract(subset(select.Eu.Pe2, delta <= 2, recalc.weights = TRUE)))
```
