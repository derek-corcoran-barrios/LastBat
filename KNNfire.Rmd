...
preprocov <-preProcess(sampling.cov[,15:23], method = c("center","scale", "knnImpute"))
sampling.cov<-predict(preprocov, sampling.cov[,15:23])

sampling.cov.zero<- Grandtotal[,53:83]
sampling.cov.zero <- sampling.cov.zero[,-c(7,8,17:22)]
preprocov.zero <-preProcess(sampling.cov.zero[,15:23], method = c("center","scale"))


preproDaily <-preProcess(Grandtotal, method = c("center","scale", "knnImpute"))
Grandtotal<-predict(preproDaily, Grandtotal)
...
Pred.DF<-predict(preprocov.zero, new=Pred.DF)
...
#N=49a
FireBats<-stack(Occu1.layer.MyYu2$Predicted, Occu1.layer.MyCi2$Predicted*PNF,Occu1.layer.MyVo2$Predicted*PNF,Occu1.layer.MyLu2$Predicted*PNF, Occu1.layer.LaBl2$Predicted*PNF, Occu1.layer.MyEv2$Predicted*PNF,Occu1.layer.AnPa2$Predicted*PNF, Occu1.layer.MyTh2$Predicted*PNF, Occu1.layer.CoTo2$Predicted*PNF, Occu1.layer.PaHe2$Predicted*PNF, Occu1.layer.EpFu2$Predicted*PNF, Occu1.layer.LaNo2$Predicted*PNF, Occu1.layer.TaBr2$Predicted*PNF, Occu1.layer.LaCi2$Predicted*PNF, Occu1.layer.EuMa2$Predicted*PNF,Occu1.layer.EuPe2$Predicted*PNF)
names(FireBats)<-c("MYYU","MYCI", "MYVO" ,"MYLU", "LABL","MYEV" ,"ANPA", "MYTH", "COTO", "PAHE", "EPFU","LANO", "TABR", "LACI", "EUMA", "EUPE")
